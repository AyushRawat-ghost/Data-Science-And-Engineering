...
BEGIN
    ...
    BEGIN TRY
		...
		PRINT 'Deleting Content : silver.crm_cust_info';
        ...
        SET @start_time = GETDATE();
		PRINT 'Deleting Content : silver.crm_prd_info';
        ...
        SET @start_time = GETDATE();
		PRINT ': sDeleting Content : silver.crm_sales_details';
        ...
        SET @start_time = GETDATE();
		PRINT 'Deleting Content : silver.erp_cust_az12';
        ...
        SET @start_time = GETDATE();
		PRINT 'Deleting Content : silver.erp_loc_a101';
